...
# This file was *autogenerated* from the file Flow_Category/Flow.sage
...
def entrance_path_poset(X, w, z):
    ...
    chains = [tuple(chain) for chain in I.chains() if len(chain) >= _sage_const_2  and chain[_sage_const_0 ] == w and chain[-_sage_const_1 ] == z]
