...
# This file was *autogenerated* from the file Flow_Category/Strong.sage
...
def is_dominated(X, v, verbose):
    ...
    for candidate in candidates:
        ...
        if dominates:
            return (True, candidate[_sage_const_0 ])
...
def strong_Morse_reduction(X, critical_cells=None, matching=None, verbose=False):
    ...
    if len(X.minimal_elements()) == _sage_const_0 :
    ...
    for v in minimal_elements:
        ...
        if is_dominated_result[_sage_const_0 ]:  # If `v` is dominated
            dominating_vertex = is_dominated_result[_sage_const_1 ]
            ...
            for simplex in X:
                if v[_sage_const_0 ] in simplex and dominating_vertex in simplex:
            ...
            X = X.subposet([x for x in X.list() if v[_sage_const_0 ] not in x])
    ...
    if len(minimal_elements) > _sage_const_0 :
...
def strong_core(X):
    ...
    if len(X)==_sage_const_1 : return X
